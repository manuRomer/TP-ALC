...
def QR_con_HH(A, tol=1e-12, retorna_nops=False):
    ...
    ## CORRECCION: Hacer que devuelva la version reducida
    R_economica = R[:n, :] 
    Q_economica = Q[:, :n]
...
def pinvEcuacionesNormales(X,L,Y):
    ...
    ## CORRECCION: Pasamos la verificacion de pseudo-inversa aca
    print('Es pseudo-inversa con EN: ', esPseudoInversa(X, V))
    ## CORRECCION: Devolver solo W
    return W
...
def pinvSVD(U, S, V, Y):
    ...
    ## CORRECCION: hacer que soporte a S como vector o matriz.
    if S.ndim == 1:
        S = np.diag(S)
    ...
    ## CORRECCION: Pasamos la verificacion de pseudo-inversa aca
    print('Es pseudo-inversa con SVD: ', esPseudoInversa(multi_matricial(multi_matricial(U,S),traspuesta(V)), pseudoInversa))
    ## CORRECCION: Devolver solo W
    return W
...
def pinvHouseHolder(Q,R,Y):
    ...
    ## CORRECCION: Pasamos la verificacion de pseudo-inversa aca
    Xt = traspuesta(multi_matricial(Q,R))
    print('Es pseudo-inversa con QRHH: ', esPseudoInversa(Xt, V))
    ## CORRECCION: Devolver solo W
    return W
...
def pinvGramSchmidt(Q,R,Y):
    ...
    ## CORRECCION: Pasamos la verificacion de pseudo-inversa aca
    Xt = traspuesta(multi_matricial(Q,R))
    print('Es pseudo-inversa con QRGS: ', esPseudoInversa(Xt, V))
    ## CORRECCION: Devolver solo W
    return W
